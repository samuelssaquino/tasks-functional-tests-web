...
public class tasksTest {
    ...
    public WebDriver acessarAplicacao() throws MalformedURLException{
        ...
        WebDriver driver = new RemoteWebDriver(new URL("http://192.168.154.70:4444/wd/hub"), browserOptions);
        driver.navigate().to("http://192.168.154.70:8001/tasks");
    ...
    public void naoDeveSalvarTarefaSemData() throws MalformedURLException{
        ...
        try {
            ...
            driver.findElement(By.id("saveButton")).click();
            String msg = driver.findElement(By.id("message")).getText();
            assertEquals("Fill the due date", msg);
        } finally {
            driver.quit();
        }
    }
